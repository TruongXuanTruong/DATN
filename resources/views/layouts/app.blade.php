        ...
        <div class="flex justify-between">
            ...
            <div class="flex items-center">
                ...
                <button data-dropdown
                    ...
                    <span class="ml-4 text-sm hidden md:inline-block">Xuân Trường</span>
                    ...
                    <div data-dropdown-items
                        ...
                        <ul>
                            <li class="px-4 py-3 border-b hover:bg-gray-200"><a href="#">Hồ sơ của tôi</a></li>
                            <li class="px-4 py-3 border-b hover:bg-gray-200"><a href="#">Cài đặt</a></li>
                            <li class="px-4 py-3 hover:bg-gray-200"><a href="{{ route('logout') }}">Đăng xuất</a></li>
                        </ul>
                    </div>
                </button>
            ...
            <div class="sidebar text-center bg-gray-900">
                <div class="text-gray-100 text-xl">
                    <div class="p-2.5 mt-1 flex items-center">
                        ...
                        <h1 class="font-bold text-gray-200 text-[15px] ml-3">Quản trị viên</h1>
                    </div>
                ...
                <a href="{{ route('admin/home') }}">
                    <div
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Trang chủ</span>
                    </div>
                </a>
                <a href="">
                    <div
                ...
                <a href="">
                    <div
                        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Hồ sơ</span>
                    </div>
                </a>
                <a href="{{ route('logout') }}">
